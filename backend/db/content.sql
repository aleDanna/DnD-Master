...
('Skeleton', 'skeleton', 'Medium', 'undead', NULL, 'lawful evil', 13, 'armor scraps', 13, '2d8 + 4', '{"walk": 30}', '{"strength": 10, "dexterity": 14, "constitution": 15, "intelligence": 6, "wisdom": 8, "charisma": 5}', NULL, NULL, '{"darkvision": 60, "passive_perception": 9}', ARRAY['understands languages it knew in life'], '1/4', 0.25, 50, '{}', '{"shortsword": {"type": "melee", "attack_bonus": 4, "reach": "5 ft.", "damage": "1d6 + 2", "damage_type": "piercing"}, "shortbow": {"type": "ranged", "attack_bonus": 4, "range": "80/320 ft.", "damage": "1d6 + 2", "damage_type": "piercing"}}', 'Skeletons arise when animated by dark magic. They heed the summons of spellcasters who call them from their stony tombs and ancient battlefields.', 'rules.txt', 178),
