...
-- Cantrips (Level 0)
INSERT INTO spells (name, slug, level, school, casting_time, range, components, materials, duration, concentration, ritual, description, higher_levels, source_document, source_page) VALUES
...
-- CR 0 Monsters
INSERT INTO monsters (name, slug, size, type, subtype, alignment, armor_class, armor_type, hit_points, hit_dice, speed, ability_scores, saving_throws, skills, senses, languages, challenge_rating, challenge_rating_numeric, experience_points, traits, actions, description, source_document, source_page) VALUES
('Bat', 'bat', 'Tiny', 'beast', NULL, 'unaligned', 12, NULL, 1, '1d4 - 1', '{"walk": 5, "fly": 30}', '{"strength": 2, "dexterity": 15, "constitution": 8, "intelligence": 2, "wisdom": 12, "charisma": 4}', NULL, NULL, '{"blindsight": 60, "passive_perception": 11}', NULL, '0', 0, 10, '{"echolocation": "The bat can''t use its blindsight while deafened.", "keen_hearing": "The bat has advantage on Wisdom (Perception) checks that rely on hearing."}', '{"bite": {"type": "melee", "attack_bonus": 0, "reach": "5 ft.", "damage": "1", "damage_type": "piercing"}}', 'Bats are nocturnal flying mammals that use echolocation to navigate in darkness.', 'handbook.txt', 304),

('Cat', 'cat', 'Tiny', 'beast', NULL, 'unaligned', 12, NULL, 2, '1d4', '{"walk": 40, "climb": 30}', '{"strength": 3, "dexterity": 15, "constitution": 10, "intelligence": 3, "wisdom": 12, "charisma": 7}', NULL, '{"perception": 3, "stealth": 4}', '{"passive_perception": 13}', NULL, '0', 0, 10, '{"keen_smell": "The cat has advantage on Wisdom (Perception) checks that rely on smell."}', '{"claws": {"type": "melee", "attack_bonus": 0, "reach": "5 ft.", "damage": "1", "damage_type": "slashing"}}', 'Cats are small feline predators, often kept as pets or to control vermin.', 'handbook.txt', 304),

('Frog', 'frog', 'Tiny', 'beast', NULL, 'unaligned', 11, NULL, 1, '1d4 - 1', '{"walk": 20, "swim": 20}', '{"strength": 1, "dexterity": 13, "constitution": 8, "intelligence": 1, "wisdom": 8, "charisma": 3}', NULL, '{"perception": 1, "stealth": 3}', '{"darkvision": 30, "passive_perception": 11}', NULL, '0', 0, 0, '{"amphibious": "The frog can breathe air and water.", "standing_leap": "The frog''s long jump is up to 10 feet and its high jump is up to 5 feet, with or without a running start."}', '{}', 'A small amphibian found near bodies of water.', 'handbook.txt', 305),

('Hawk', 'hawk', 'Tiny', 'beast', NULL, 'unaligned', 13, NULL, 1, '1d4 - 1', '{"walk": 10, "fly": 60}', '{"strength": 5, "dexterity": 16, "constitution": 8, "intelligence": 2, "wisdom": 14, "charisma": 6}', NULL, '{"perception": 4}', '{"passive_perception": 14}', NULL, '0', 0, 10, '{"keen_sight": "The hawk has advantage on Wisdom (Perception) checks that rely on sight."}', '{"talons": {"type": "melee", "attack_bonus": 5, "reach": "5 ft.", "damage": "1", "damage_type": "slashing"}}', 'Hawks are birds of prey that hunt small animals and are sometimes trained as hunting companions.', 'handbook.txt', 306),

('Owl', 'owl', 'Tiny', 'beast', NULL, 'unaligned', 11, NULL, 1, '1d4 - 1', '{"walk": 5, "fly": 60}', '{"strength": 3, "dexterity": 13, "constitution": 8, "intelligence": 2, "wisdom": 12, "charisma": 7}', NULL, '{"perception": 3, "stealth": 3}', '{"darkvision": 120, "passive_perception": 13}', NULL, '0', 0, 10, '{"flyby": "The owl doesn''t provoke opportunity attacks when it flies out of an enemy''s reach.", "keen_hearing_and_sight": "The owl has advantage on Wisdom (Perception) checks that rely on hearing or sight."}', '{"talons": {"type": "melee", "attack_bonus": 3, "reach": "5 ft.", "damage": "1", "damage_type": "slashing"}}', 'Owls are nocturnal birds of prey known for their silent flight and keen senses.', 'handbook.txt', 307),

('Rat', 'rat', 'Tiny', 'beast', NULL, 'unaligned', 10, NULL, 1, '1d4 - 1', '{"walk": 20}', '{"strength": 2, "dexterity": 11, "constitution": 9, "intelligence": 2, "wisdom": 10, "charisma": 4}', NULL, NULL, '{"darkvision": 30, "passive_perception": 10}', NULL, '0', 0, 10, '{"keen_smell": "The rat has advantage on Wisdom (Perception) checks that rely on smell."}', '{"bite": {"type": "melee", "attack_bonus": 0, "reach": "5 ft.", "damage": "1", "damage_type": "piercing"}}', 'Rats are small rodents found in most environments, often associated with disease and filth.', 'handbook.txt', 309),

('Raven', 'raven', 'Tiny', 'beast', NULL, 'unaligned', 12, NULL, 1, '1d4 - 1', '{"walk": 10, "fly": 50}', '{"strength": 2, "dexterity": 14, "constitution": 8, "intelligence": 2, "wisdom": 12, "charisma": 6}', NULL, '{"perception": 3}', '{"passive_perception": 13}', NULL, '0', 0, 10, '{"mimicry": "The raven can mimic simple sounds it has heard. A creature that hears the sounds can tell they are imitations with a successful DC 10 Wisdom (Insight) check."}', '{"beak": {"type": "melee", "attack_bonus": 4, "reach": "5 ft.", "damage": "1", "damage_type": "piercing"}}', 'Ravens are intelligent black birds known for their ability to mimic sounds.', 'handbook.txt', 309);

-- CR 1/8 Monsters
INSERT INTO monsters (name, slug, size, type, subtype, alignment, armor_class, armor_type, hit_points, hit_dice, speed, ability_scores, saving_throws, skills, senses, languages, challenge_rating, challenge_rating_numeric, experience_points, traits, actions, description, source_document, source_page) VALUES
('Mastiff', 'mastiff', 'Medium', 'beast', NULL, 'unaligned', 12, NULL, 5, '1d8 + 1', '{"walk": 40}', '{"strength": 13, "dexterity": 14, "constitution": 12, "intelligence": 3, "wisdom": 12, "charisma": 7}', NULL, '{"perception": 3}', '{"passive_perception": 13}', NULL, '1/8', 0.125, 25, '{"keen_hearing_and_smell": "The mastiff has advantage on Wisdom (Perception) checks that rely on hearing or smell."}', '{"bite": {"type": "melee", "attack_bonus": 3, "reach": "5 ft.", "damage": "1d6 + 1", "damage_type": "piercing", "special": "If the target is a creature, it must succeed on a DC 11 Strength saving throw or be knocked prone."}}', 'Mastiffs are large, powerful dogs bred for guarding and hunting.', 'handbook.txt', 307),

('Mule', 'mule', 'Medium', 'beast', NULL, 'unaligned', 10, NULL, 11, '2d8 + 2', '{"walk": 40}', '{"strength": 14, "dexterity": 10, "constitution": 13, "intelligence": 2, "wisdom": 10, "charisma": 5}', NULL, NULL, '{"passive_perception": 10}', NULL, '1/8', 0.125, 25, '{"beast_of_burden": "The mule is considered to be a Large animal for the purpose of determining its carrying capacity.", "sure_footed": "The mule has advantage on Strength and Dexterity saving throws made against effects that would knock it prone."}', '{"hooves": {"type": "melee", "attack_bonus": 2, "reach": "5 ft.", "damage": "1d4 + 2", "damage_type": "bludgeoning"}}', 'Mules are sturdy beasts of burden, a crossbreed of horse and donkey.', 'handbook.txt', 307),

('Poisonous Snake', 'poisonous-snake', 'Tiny', 'beast', NULL, 'unaligned', 13, NULL, 2, '1d4', '{"walk": 30, "swim": 30}', '{"strength": 2, "dexterity": 16, "constitution": 11, "intelligence": 1, "wisdom": 10, "charisma": 3}', NULL, NULL, '{"blindsight": 10, "passive_perception": 10}', NULL, '1/8', 0.125, 25, '{}', '{"bite": {"type": "melee", "attack_bonus": 5, "reach": "5 ft.", "damage": "1", "damage_type": "piercing", "special": "The target must make a DC 10 Constitution saving throw, taking 5 (2d4) poison damage on a failed save, or half as much damage on a successful one."}}', 'Poisonous snakes deliver venom through their bite, making them dangerous despite their small size.', 'handbook.txt', 307);

-- CR 1/4 Monsters
INSERT INTO monsters (name, slug, size, type, subtype, alignment, armor_class, armor_type, hit_points, hit_dice, speed, ability_scores, saving_throws, skills, senses, languages, challenge_rating, challenge_rating_numeric, experience_points, traits, actions, description, source_document, source_page) VALUES
('Goblin', 'goblin', 'Small', 'humanoid', 'goblinoid', 'neutral evil', 15, 'leather armor, shield', 7, '2d6', '{"walk": 30}', '{"strength": 8, "dexterity": 14, "constitution": 10, "intelligence": 10, "wisdom": 8, "charisma": 8}', NULL, '{"stealth": 6}', '{"darkvision": 60, "passive_perception": 9}', ARRAY['Common', 'Goblin'], '1/4', 0.25, 50, '{"nimble_escape": "The goblin can take the Disengage or Hide action as a bonus action on each of its turns."}', '{"scimitar": {"type": "melee", "attack_bonus": 4, "reach": "5 ft.", "damage": "1d6 + 2", "damage_type": "slashing"}, "shortbow": {"type": "ranged", "attack_bonus": 4, "range": "80/320 ft.", "damage": "1d6 + 2", "damage_type": "piercing"}}', 'Goblins are small, black-hearted humanoids that lair in despoiled dungeons and other dismal settings. Individually weak, they gather in large numbers to torment other creatures.', 'rules.txt', 166),

('Kobold', 'kobold', 'Small', 'humanoid', 'kobold', 'lawful evil', 12, NULL, 5, '2d6 - 2', '{"walk": 30}', '{"strength": 7, "dexterity": 15, "constitution": 9, "intelligence": 8, "wisdom": 7, "charisma": 8}', NULL, NULL, '{"darkvision": 60, "passive_perception": 8}', ARRAY['Common', 'Draconic'], '1/8', 0.125, 25, '{"sunlight_sensitivity": "While in sunlight, the kobold has disadvantage on attack rolls, as well as on Wisdom (Perception) checks that rely on sight.", "pack_tactics": "The kobold has advantage on an attack roll against a creature if at least one of the kobold''s allies is within 5 feet of the creature and the ally isn''t incapacitated."}', '{"dagger": {"type": "melee", "attack_bonus": 4, "reach": "5 ft.", "damage": "1d4 + 2", "damage_type": "piercing"}, "sling": {"type": "ranged", "attack_bonus": 4, "range": "30/120 ft.", "damage": "1d4 + 2", "damage_type": "bludgeoning"}}', 'Kobolds are craven reptilian humanoids that commonly infest dungeons. They make up for their physical ineptitude with a cleverness for trap making.', 'rules.txt', 170),

('Boar', 'boar', 'Medium', 'beast', NULL, 'unaligned', 11, 'natural armor', 11, '2d8 + 2', '{"walk": 40}', '{"strength": 13, "dexterity": 11, "constitution": 12, "intelligence": 2, "wisdom": 9, "charisma": 5}', NULL, NULL, '{"passive_perception": 9}', NULL, '1/4', 0.25, 50, '{"charge": "If the boar moves at least 20 feet straight toward a target and then hits it with a tusk attack on the same turn, the target takes an extra 3 (1d6) slashing damage. If the target is a creature, it must succeed on a DC 11 Strength saving throw or be knocked prone.", "relentless": "If the boar takes 7 damage or less that would reduce it to 0 hit points, it is reduced to 1 hit point instead."}', '{"tusk": {"type": "melee", "attack_bonus": 3, "reach": "5 ft.", "damage": "1d6 + 1", "damage_type": "slashing"}}', 'Wild boars are aggressive and dangerous when threatened, using their tusks to gore enemies.', 'handbook.txt', 304),

('Constrictor Snake', 'constrictor-snake', 'Large', 'beast', NULL, 'unaligned', 12, NULL, 13, '2d10 + 2', '{"walk": 30, "swim": 30}', '{"strength": 15, "dexterity": 14, "constitution": 12, "intelligence": 1, "wisdom": 10, "charisma": 3}', NULL, NULL, '{"blindsight": 10, "passive_perception": 10}', NULL, '1/4', 0.25, 50, '{}', '{"bite": {"type": "melee", "attack_bonus": 4, "reach": "5 ft.", "damage": "1d6 + 2", "damage_type": "piercing"}, "constrict": {"type": "melee", "attack_bonus": 4, "reach": "5 ft.", "damage": "1d8 + 2", "damage_type": "bludgeoning", "special": "The target is grappled (escape DC 14). Until this grapple ends, the creature is restrained, and the snake can''t constrict another target."}}', 'Constrictor snakes kill prey by wrapping around them and squeezing until they suffocate.', 'handbook.txt', 305),

('Panther', 'panther', 'Medium', 'beast', NULL, 'unaligned', 12, NULL, 13, '3d8', '{"walk": 50, "climb": 40}', '{"strength": 14, "dexterity": 15, "constitution": 10, "intelligence": 3, "wisdom": 14, "charisma": 7}', NULL, '{"perception": 4, "stealth": 6}', '{"passive_perception": 14}', NULL, '1/4', 0.25, 50, '{"keen_smell": "The panther has advantage on Wisdom (Perception) checks that rely on smell.", "pounce": "If the panther moves at least 20 feet straight toward a creature and then hits it with a claw attack on the same turn, that target must succeed on a DC 12 Strength saving throw or be knocked prone. If the target is prone, the panther can make one bite attack against it as a bonus action."}', '{"bite": {"type": "melee", "attack_bonus": 4, "reach": "5 ft.", "damage": "1d6 + 2", "damage_type": "piercing"}, "claw": {"type": "melee", "attack_bonus": 4, "reach": "5 ft.", "damage": "1d4 + 2", "damage_type": "slashing"}}', 'Panthers are stealthy predators that stalk their prey through forests and jungles.', 'handbook.txt', 308),

('Pseudodragon', 'pseudodragon', 'Tiny', 'dragon', NULL, 'neutral good', 13, 'natural armor', 7, '2d4 + 2', '{"walk": 15, "fly": 60}', '{"strength": 6, "dexterity": 15, "constitution": 13, "intelligence": 10, "wisdom": 12, "charisma": 10}', NULL, '{"perception": 3, "stealth": 4}', '{"blindsight": 10, "darkvision": 60, "passive_perception": 13}', ARRAY['understands Common and Draconic but can''t speak'], '1/4', 0.25, 50, '{"keen_senses": "The pseudodragon has advantage on Wisdom (Perception) checks that rely on sight, hearing, or smell.", "magic_resistance": "The pseudodragon has advantage on saving throws against spells and other magical effects.", "limited_telepathy": "The pseudodragon can magically communicate simple ideas, emotions, and images telepathically with any creature within 100 feet of it that can understand a language."}', '{"bite": {"type": "melee", "attack_bonus": 4, "reach": "5 ft.", "damage": "1d4 + 2", "damage_type": "piercing"}, "sting": {"type": "melee", "attack_bonus": 4, "reach": "5 ft.", "damage": "1d4 + 2", "damage_type": "piercing", "special": "The target must succeed on a DC 11 Constitution saving throw or become poisoned for 1 hour. If the saving throw fails by 5 or more, the target falls unconscious for the same duration, or until it takes damage or another creature uses an action to shake it awake."}}', 'Pseudodragons are tiny, cat-sized dragons that are sometimes sought out as familiars by wizards.', 'handbook.txt', 308),

('Riding Horse', 'riding-horse', 'Large', 'beast', NULL, 'unaligned', 10, NULL, 13, '2d10 + 2', '{"walk": 60}', '{"strength": 16, "dexterity": 10, "constitution": 12, "intelligence": 2, "wisdom": 11, "charisma": 7}', NULL, NULL, '{"passive_perception": 10}', NULL, '1/4', 0.25, 50, '{}', '{"hooves": {"type": "melee", "attack_bonus": 2, "reach": "5 ft.", "damage": "2d4 + 3", "damage_type": "bludgeoning"}}', 'Riding horses are commonly used as mounts for travel and light combat.', 'handbook.txt', 310),

('Sprite', 'sprite', 'Tiny', 'fey', NULL, 'neutral good', 15, 'leather armor', 2, '1d4', '{"walk": 10, "fly": 40}', '{"strength": 3, "dexterity": 18, "constitution": 10, "intelligence": 14, "wisdom": 13, "charisma": 11}', NULL, '{"perception": 3, "stealth": 8}', '{"passive_perception": 13}', ARRAY['Common', 'Elvish', 'Sylvan'], '1/4', 0.25, 50, '{}', '{"longsword": {"type": "melee", "attack_bonus": 2, "reach": "5 ft.", "damage": "1", "damage_type": "slashing"}, "shortbow": {"type": "ranged", "attack_bonus": 6, "range": "40/160 ft.", "damage": "1", "damage_type": "piercing", "special": "The target must succeed on a DC 10 Constitution saving throw or become poisoned for 1 minute. If the saving throw fails by 5 or more, the poisoned target falls unconscious for the same duration, or until it takes damage or another creature takes an action to shake it awake."}, "heart_sight": {"special": "The sprite touches a creature and magically knows the creature''s current emotional state. If the target fails a DC 10 Charisma saving throw, the sprite also knows the creature''s alignment."}, "invisibility": {"special": "The sprite magically turns invisible until it attacks or casts a spell, or until its concentration ends."}}', 'Sprites are tiny fey creatures that protect natural places from evil.', 'handbook.txt', 310),

('Wolf', 'wolf', 'Medium', 'beast', NULL, 'unaligned', 13, 'natural armor', 11, '2d8 + 2', '{"walk": 40}', '{"strength": 12, "dexterity": 15, "constitution": 12, "intelligence": 3, "wisdom": 12, "charisma": 6}', NULL, '{"perception": 3, "stealth": 4}', '{"passive_perception": 13}', NULL, '1/4', 0.25, 50, '{"keen_hearing_and_smell": "The wolf has advantage on Wisdom (Perception) checks that rely on hearing or smell.", "pack_tactics": "The wolf has advantage on attack rolls against a creature if at least one of the wolf''s allies is within 5 feet of the creature and the ally isn''t incapacitated."}', '{"bite": {"type": "melee", "attack_bonus": 4, "reach": "5 ft.", "damage": "2d4 + 2", "damage_type": "piercing", "special": "If the target is a creature, it must succeed on a DC 11 Strength saving throw or be knocked prone."}}', 'Wolves are pack hunters known for their cunning and cooperative hunting tactics.', 'handbook.txt', 311);

-- CR 1/2 Monsters
INSERT INTO monsters (name, slug, size, type, subtype, alignment, armor_class, armor_type, hit_points, hit_dice, speed, ability_scores, saving_throws, skills, senses, languages, challenge_rating, challenge_rating_numeric, experience_points, traits, actions, description, source_document, source_page) VALUES
('Orc', 'orc', 'Medium', 'humanoid', 'orc', 'chaotic evil', 13, 'hide armor', 15, '2d8 + 6', '{"walk": 30}', '{"strength": 16, "dexterity": 12, "constitution": 16, "intelligence": 7, "wisdom": 11, "charisma": 10}', NULL, '{"intimidation": 2}', '{"darkvision": 60, "passive_perception": 10}', ARRAY['Common', 'Orc'], '1/2', 0.5, 100, '{"aggressive": "As a bonus action, the orc can move up to its speed toward a hostile creature that it can see."}', '{"greataxe": {"type": "melee", "attack_bonus": 5, "reach": "5 ft.", "damage": "1d12 + 3", "damage_type": "slashing"}, "javelin": {"type": "melee_or_ranged", "attack_bonus": 5, "reach": "5 ft.", "range": "30/120 ft.", "damage": "1d6 + 3", "damage_type": "piercing"}}', 'Orcs are savage raiders and pillagers with stooped postures, low foreheads, and piggish faces with prominent lower canines that resemble tusks.', 'rules.txt', 172),

('Black Bear', 'black-bear', 'Medium', 'beast', NULL, 'unaligned', 11, 'natural armor', 19, '3d8 + 6', '{"walk": 40, "climb": 30}', '{"strength": 15, "dexterity": 10, "constitution": 14, "intelligence": 2, "wisdom": 12, "charisma": 7}', NULL, '{"perception": 3}', '{"passive_perception": 13}', NULL, '1/2', 0.5, 100, '{"keen_smell": "The bear has advantage on Wisdom (Perception) checks that rely on smell."}', '{"multiattack": "The bear makes two attacks: one with its bite and one with its claws.", "bite": {"type": "melee", "attack_bonus": 3, "reach": "5 ft.", "damage": "1d6 + 2", "damage_type": "piercing"}, "claws": {"type": "melee", "attack_bonus": 3, "reach": "5 ft.", "damage": "2d4 + 2", "damage_type": "slashing"}}', 'Black bears are omnivorous mammals that typically avoid confrontation but will fight fiercely to protect their cubs.', 'handbook.txt', 304),

('Crocodile', 'crocodile', 'Large', 'beast', NULL, 'unaligned', 12, 'natural armor', 19, '3d10 + 3', '{"walk": 20, "swim": 30}', '{"strength": 15, "dexterity": 10, "constitution": 13, "intelligence": 2, "wisdom": 10, "charisma": 5}', NULL, '{"stealth": 2}', '{"passive_perception": 10}', NULL, '1/2', 0.5, 100, '{"hold_breath": "The crocodile can hold its breath for 15 minutes."}', '{"bite": {"type": "melee", "attack_bonus": 4, "reach": "5 ft.", "damage": "1d10 + 2", "damage_type": "piercing", "special": "The target is grappled (escape DC 12). Until this grapple ends, the target is restrained, and the crocodile can''t bite another target."}}', 'Crocodiles are large aquatic reptiles that ambush prey at the water''s edge.', 'handbook.txt', 305),

('Reef Shark', 'reef-shark', 'Medium', 'beast', NULL, 'unaligned', 12, 'natural armor', 22, '4d8 + 4', '{"swim": 40}', '{"strength": 14, "dexterity": 13, "constitution": 13, "intelligence": 1, "wisdom": 10, "charisma": 4}', NULL, '{"perception": 2}', '{"blindsight": 30, "passive_perception": 12}', NULL, '1/2', 0.5, 100, '{"pack_tactics": "The shark has advantage on an attack roll against a creature if at least one of the shark''s allies is within 5 feet of the creature and the ally isn''t incapacitated.", "water_breathing": "The shark can breathe only underwater."}', '{"bite": {"type": "melee", "attack_bonus": 4, "reach": "5 ft.", "damage": "1d8 + 2", "damage_type": "piercing"}}', 'Reef sharks are smaller sharks that hunt in groups around coral reefs and coastal waters.', 'handbook.txt', 309),

('Warhorse', 'warhorse', 'Large', 'beast', NULL, 'unaligned', 11, NULL, 19, '3d10 + 3', '{"walk": 60}', '{"strength": 18, "dexterity": 12, "constitution": 13, "intelligence": 2, "wisdom": 12, "charisma": 7}', NULL, NULL, '{"passive_perception": 11}', NULL, '1/2', 0.5, 100, '{"trampling_charge": "If the horse moves at least 20 feet straight toward a creature and then hits it with a hooves attack on the same turn, that target must succeed on a DC 14 Strength saving throw or be knocked prone. If the target is prone, the horse can make another hooves attack against it as a bonus action."}', '{"hooves": {"type": "melee", "attack_bonus": 4, "reach": "5 ft.", "damage": "2d6 + 4", "damage_type": "bludgeoning"}}', 'Warhorses are bred and trained for combat, carrying armored riders into battle.', 'handbook.txt', 311);

-- CR 1/4 Undead
INSERT INTO monsters (name, slug, size, type, subtype, alignment, armor_class, armor_type, hit_points, hit_dice, speed, ability_scores, saving_throws, skills, senses, languages, challenge_rating, challenge_rating_numeric, experience_points, traits, actions, description, source_document, source_page) VALUES
('Skeleton', 'skeleton', 'Medium', 'undead', NULL, 'lawful evil', 13, 'armor scraps', 13, '2d8 + 4', '{"walk": 30}', '{"strength": 10, "dexterity": 14, "constitution": 15, "intelligence": 6, "wisdom": 8, "charisma": 5}', NULL, NULL, '{"darkvision": 60, "passive_perception": 9}', ARRAY['understands languages it knew in life'], '1/4', 0.25, 50, '{"damage_vulnerabilities": ["bludgeoning"], "damage_immunities": ["poison"], "condition_immunities": ["exhaustion", "poisoned"]}', '{"shortsword": {"type": "melee", "attack_bonus": 4, "reach": "5 ft.", "damage": "1d6 + 2", "damage_type": "piercing"}, "shortbow": {"type": "ranged", "attack_bonus": 4, "range": "80/320 ft.", "damage": "1d6 + 2", "damage_type": "piercing"}}', 'Skeletons arise when animated by dark magic. They heed the summons of spellcasters who call them from their stony tombs and ancient battlefields.', 'handbook.txt', 310),

('Zombie', 'zombie', 'Medium', 'undead', NULL, 'neutral evil', 8, NULL, 22, '3d8 + 9', '{"walk": 20}', '{"strength": 13, "dexterity": 6, "constitution": 16, "intelligence": 3, "wisdom": 6, "charisma": 5}', '{"wisdom": 0}', NULL, '{"darkvision": 60, "passive_perception": 8}', ARRAY['understands languages it knew in life'], '1/4', 0.25, 50, '{"undead_fortitude": "If damage reduces the zombie to 0 hit points, it must make a Constitution saving throw with a DC of 5 + the damage taken, unless the damage is radiant or from a critical hit. On a success, the zombie drops to 1 hit point instead.", "damage_immunities": ["poison"], "condition_immunities": ["poisoned"]}', '{"slam": {"type": "melee", "attack_bonus": 3, "reach": "5 ft.", "damage": "1d6 + 1", "damage_type": "bludgeoning"}}', 'From somewhere in the darkness, a gurgling moan is heard. A form emerges from the shadows, dragging one foot as it raises bloated arms and broken hands.', 'handbook.txt', 311);

-- CR 1 Monsters
INSERT INTO monsters (name, slug, size, type, subtype, alignment, armor_class, armor_type, hit_points, hit_dice, speed, ability_scores, saving_throws, skills, senses, languages, challenge_rating, challenge_rating_numeric, experience_points, traits, actions, description, source_document, source_page) VALUES
('Brown Bear', 'brown-bear', 'Large', 'beast', NULL, 'unaligned', 11, 'natural armor', 34, '4d10 + 12', '{"walk": 40, "climb": 30}', '{"strength": 19, "dexterity": 10, "constitution": 16, "intelligence": 2, "wisdom": 13, "charisma": 7}', NULL, '{"perception": 3}', '{"passive_perception": 13}', NULL, '1', 1, 200, '{"keen_smell": "The bear has advantage on Wisdom (Perception) checks that rely on smell."}', '{"multiattack": "The bear makes two attacks: one with its bite and one with its claws.", "bite": {"type": "melee", "attack_bonus": 5, "reach": "5 ft.", "damage": "1d8 + 4", "damage_type": "piercing"}, "claws": {"type": "melee", "attack_bonus": 5, "reach": "5 ft.", "damage": "2d6 + 4", "damage_type": "slashing"}}', 'Brown bears are large, powerful bears found in forests and mountains. They are more aggressive than black bears.', 'handbook.txt', 304),

('Dire Wolf', 'dire-wolf', 'Large', 'beast', NULL, 'unaligned', 14, 'natural armor', 37, '5d10 + 10', '{"walk": 50}', '{"strength": 17, "dexterity": 15, "constitution": 15, "intelligence": 3, "wisdom": 12, "charisma": 7}', NULL, '{"perception": 3, "stealth": 4}', '{"passive_perception": 13}', NULL, '1', 1, 200, '{"keen_hearing_and_smell": "The wolf has advantage on Wisdom (Perception) checks that rely on hearing or smell.", "pack_tactics": "The wolf has advantage on attack rolls against a creature if at least one of the wolf''s allies is within 5 feet of the creature and the ally isn''t incapacitated."}', '{"bite": {"type": "melee", "attack_bonus": 5, "reach": "5 ft.", "damage": "2d6 + 3", "damage_type": "piercing", "special": "If the target is a creature, it must succeed on a DC 13 Strength saving throw or be knocked prone."}}', 'Dire wolves are ancient, prehistoric wolves far larger and more ferocious than their modern descendants.', 'handbook.txt', 305),

('Giant Eagle', 'giant-eagle', 'Large', 'beast', NULL, 'neutral good', 13, NULL, 26, '4d10 + 4', '{"walk": 10, "fly": 80}', '{"strength": 16, "dexterity": 17, "constitution": 13, "intelligence": 8, "wisdom": 14, "charisma": 10}', NULL, '{"perception": 4}', '{"passive_perception": 14}', ARRAY['Giant Eagle', 'understands Common and Auran but can''t speak them'], '1', 1, 200, '{"keen_sight": "The eagle has advantage on Wisdom (Perception) checks that rely on sight."}', '{"multiattack": "The eagle makes two attacks: one with its beak and one with its talons.", "beak": {"type": "melee", "attack_bonus": 5, "reach": "5 ft.", "damage": "1d6 + 3", "damage_type": "piercing"}, "talons": {"type": "melee", "attack_bonus": 5, "reach": "5 ft.", "damage": "2d6 + 3", "damage_type": "slashing"}}', 'Giant eagles are noble creatures that speak their own language and understand Common. They often serve as mounts for good-aligned creatures.', 'handbook.txt', 306),

('Giant Spider', 'giant-spider', 'Large', 'beast', NULL, 'unaligned', 14, 'natural armor', 26, '4d10 + 4', '{"walk": 30, "climb": 30}', '{"strength": 14, "dexterity": 16, "constitution": 12, "intelligence": 2, "wisdom": 11, "charisma": 4}', NULL, '{"stealth": 7}', '{"blindsight": 10, "darkvision": 60, "passive_perception": 10}', NULL, '1', 1, 200, '{"spider_climb": "The spider can climb difficult surfaces, including upside down on ceilings, without needing to make an ability check.", "web_sense": "While in contact with a web, the spider knows the exact location of any other creature in contact with the same web.", "web_walker": "The spider ignores movement restrictions caused by webbing."}', '{"bite": {"type": "melee", "attack_bonus": 5, "reach": "5 ft.", "damage": "1d8 + 3", "damage_type": "piercing", "special": "The target must make a DC 11 Constitution saving throw, taking 9 (2d8) poison damage on a failed save, or half as much damage on a successful one. If the poison damage reduces the target to 0 hit points, the target is stable but poisoned for 1 hour, even after regaining hit points, and is paralyzed while poisoned in this way."}, "web": {"type": "ranged", "attack_bonus": 5, "range": "30/60 ft.", "special": "Recharge 5-6. The target is restrained by webbing. As an action, the restrained target can make a DC 12 Strength check, bursting the webbing on a success. The webbing can also be attacked and destroyed (AC 10; hp 5; vulnerability to fire damage; immunity to bludgeoning, poison, and psychic damage)."}}', 'Giant spiders are monstrous arachnids that spin webs to trap prey in forests, caves, and dungeons.', 'handbook.txt', 306),

('Imp', 'imp', 'Tiny', 'fiend', 'devil, shapechanger', 'lawful evil', 13, NULL, 10, '3d4 + 3', '{"walk": 20, "fly": 40}', '{"strength": 6, "dexterity": 17, "constitution": 13, "intelligence": 11, "wisdom": 12, "charisma": 14}', NULL, '{"deception": 4, "insight": 3, "persuasion": 4, "stealth": 5}', '{"darkvision": 120, "passive_perception": 11}', ARRAY['Infernal', 'Common'], '1', 1, 200, '{"shapechanger": "The imp can use its action to polymorph into a beast form that resembles a rat, a raven, or a spider, or back into its true form. Its statistics are the same in each form, except for the speed changes noted. Any equipment it is wearing or carrying isn''t transformed. It reverts to its true form if it dies.", "devils_sight": "Magical darkness doesn''t impede the imp''s darkvision.", "magic_resistance": "The imp has advantage on saving throws against spells and other magical effects.", "damage_resistances": ["cold", "bludgeoning, piercing, and slashing from nonmagical attacks not made with silvered weapons"], "damage_immunities": ["fire", "poison"], "condition_immunities": ["poisoned"]}', '{"sting": {"type": "melee", "attack_bonus": 5, "reach": "5 ft.", "damage": "1d4 + 3", "damage_type": "piercing", "special": "The target must make a DC 11 Constitution saving throw, taking 10 (3d6) poison damage on a failed save, or half as much damage on a successful one."}, "invisibility": {"special": "The imp magically turns invisible until it attacks or until its concentration ends. Any equipment the imp wears or carries is invisible with it."}}', 'Imps are small devils that serve more powerful fiends or warlocks as familiars and spies.', 'handbook.txt', 306),

('Lion', 'lion', 'Large', 'beast', NULL, 'unaligned', 12, NULL, 26, '4d10 + 4', '{"walk": 50}', '{"strength": 17, "dexterity": 15, "constitution": 13, "intelligence": 3, "wisdom": 12, "charisma": 8}', NULL, '{"perception": 3, "stealth": 6}', '{"passive_perception": 13}', NULL, '1', 1, 200, '{"keen_smell": "The lion has advantage on Wisdom (Perception) checks that rely on smell.", "pack_tactics": "The lion has advantage on an attack roll against a creature if at least one of the lion''s allies is within 5 feet of the creature and the ally isn''t incapacitated.", "pounce": "If the lion moves at least 20 feet straight toward a creature and then hits it with a claw attack on the same turn, that target must succeed on a DC 13 Strength saving throw or be knocked prone. If the target is prone, the lion can make one bite attack against it as a bonus action.", "running_leap": "With a 10-foot running start, the lion can long jump up to 25 feet."}', '{"bite": {"type": "melee", "attack_bonus": 5, "reach": "5 ft.", "damage": "1d8 + 3", "damage_type": "piercing"}, "claw": {"type": "melee", "attack_bonus": 5, "reach": "5 ft.", "damage": "1d6 + 3", "damage_type": "slashing"}}', 'Lions are powerful predators that hunt in groups called prides on savannas and grasslands.', 'handbook.txt', 307),

('Quasit', 'quasit', 'Tiny', 'fiend', 'demon, shapechanger', 'chaotic evil', 13, NULL, 7, '3d4', '{"walk": 40}', '{"strength": 5, "dexterity": 17, "constitution": 10, "intelligence": 7, "wisdom": 10, "charisma": 10}', NULL, '{"stealth": 5}', '{"darkvision": 120, "passive_perception": 10}', ARRAY['Abyssal', 'Common'], '1', 1, 200, '{"shapechanger": "The quasit can use its action to polymorph into a beast form that resembles a bat, a centipede, or a toad, or back into its true form. Its statistics are the same in each form, except for the speed changes noted. Any equipment it is wearing or carrying isn''t transformed. It reverts to its true form if it dies.", "magic_resistance": "The quasit has advantage on saving throws against spells and other magical effects.", "damage_resistances": ["cold", "fire", "lightning", "bludgeoning, piercing, and slashing from nonmagical attacks"], "damage_immunities": ["poison"], "condition_immunities": ["poisoned"]}', '{"claws": {"type": "melee", "attack_bonus": 4, "reach": "5 ft.", "damage": "1d4 + 3", "damage_type": "piercing", "special": "The target must succeed on a DC 10 Constitution saving throw or take 5 (2d4) poison damage and become poisoned for 1 minute. The target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success."}, "scare": {"special": "1/Day. One creature of the quasit''s choice within 20 feet of it must succeed on a DC 10 Wisdom saving throw or be frightened for 1 minute. The target can repeat the saving throw at the end of each of its turns, with disadvantage if the quasit is within line of sight, ending the effect on itself on a success."}, "invisibility": {"special": "The quasit magically turns invisible until it attacks or uses Scare, or until its concentration ends. Any equipment the quasit wears or carries is invisible with it."}}', 'Quasits are tiny demons that serve as familiars to spellcasters or as spies for more powerful fiends.', 'handbook.txt', 309),

('Tiger', 'tiger', 'Large', 'beast', NULL, 'unaligned', 12, NULL, 37, '5d10 + 10', '{"walk": 40}', '{"strength": 17, "dexterity": 15, "constitution": 14, "intelligence": 3, "wisdom": 12, "charisma": 8}', NULL, '{"perception": 3, "stealth": 6}', '{"darkvision": 60, "passive_perception": 13}', NULL, '1', 1, 200, '{"keen_smell": "The tiger has advantage on Wisdom (Perception) checks that rely on smell.", "pounce": "If the tiger moves at least 20 feet straight toward a creature and then hits it with a claw attack on the same turn, that target must succeed on a DC 13 Strength saving throw or be knocked prone. If the target is prone, the tiger can make one bite attack against it as a bonus action."}', '{"bite": {"type": "melee", "attack_bonus": 5, "reach": "5 ft.", "damage": "1d10 + 3", "damage_type": "piercing"}, "claw": {"type": "melee", "attack_bonus": 5, "reach": "5 ft.", "damage": "1d8 + 3", "damage_type": "slashing"}}', 'Tigers are solitary, powerful predators that stalk their prey through jungles and forests.', 'handbook.txt', 311);

-- CR 2-5 Monsters
INSERT INTO monsters (name, slug, size, type, subtype, alignment, armor_class, armor_type, hit_points, hit_dice, speed, ability_scores, saving_throws, skills, senses, languages, challenge_rating, challenge_rating_numeric, experience_points, traits, actions, description, source_document, source_page) VALUES
('Ogre', 'ogre', 'Large', 'giant', NULL, 'chaotic evil', 11, 'hide armor', 59, '7d10 + 21', '{"walk": 40}', '{"strength": 19, "dexterity": 8, "constitution": 16, "intelligence": 5, "wisdom": 7, "charisma": 7}', NULL, NULL, '{"darkvision": 60, "passive_perception": 8}', ARRAY['Common', 'Giant'], '2', 2, 450, '{}', '{"greatclub": {"type": "melee", "attack_bonus": 6, "reach": "5 ft.", "damage": "2d8 + 4", "damage_type": "bludgeoning"}, "javelin": {"type": "melee_or_ranged", "attack_bonus": 6, "reach": "5 ft.", "range": "30/120 ft.", "damage": "2d6 + 4", "damage_type": "piercing"}}', 'Ogres are as lazy of mind as they are strong of body. They live by raiding, scavenging, and killing for food and pleasure.', 'rules.txt', 172),

('Owlbear', 'owlbear', 'Large', 'monstrosity', NULL, 'unaligned', 13, 'natural armor', 59, '7d10 + 21', '{"walk": 40}', '{"strength": 20, "dexterity": 12, "constitution": 17, "intelligence": 3, "wisdom": 12, "charisma": 7}', NULL, '{"perception": 3}', '{"darkvision": 60, "passive_perception": 13}', NULL, '3', 3, 700, '{"keen_sight_and_smell": "The owlbear has advantage on Wisdom (Perception) checks that rely on sight or smell."}', '{"multiattack": "The owlbear makes two attacks: one with its beak and one with its claws.", "beak": {"type": "melee", "attack_bonus": 7, "reach": "5 ft.", "damage": "1d10 + 5", "damage_type": "piercing"}, "claws": {"type": "melee", "attack_bonus": 7, "reach": "5 ft.", "damage": "2d8 + 5", "damage_type": "slashing"}}', 'An owlbear''s screech echoes through dark valleys and benighted forests, striking fear into the hearts of those who hear it.', 'rules.txt', 173),

('Wight', 'wight', 'Medium', 'undead', NULL, 'neutral evil', 14, 'studded leather', 45, '6d8 + 18', '{"walk": 30}', '{"strength": 15, "dexterity": 14, "constitution": 16, "intelligence": 10, "wisdom": 13, "charisma": 15}', NULL, '{"perception": 3, "stealth": 4}', '{"darkvision": 60, "passive_perception": 13}', ARRAY['languages it knew in life'], '3', 3, 700, '{"sunlight_sensitivity": "While in sunlight, the wight has disadvantage on attack rolls, as well as on Wisdom (Perception) checks that rely on sight."}', '{"multiattack": "The wight makes two longsword attacks or two longbow attacks. It can use its Life Drain in place of one longsword attack.", "life_drain": {"type": "melee", "attack_bonus": 4, "reach": "5 ft.", "damage": "1d6 + 2", "damage_type": "necrotic", "special": "The target must succeed on a DC 13 Constitution saving throw or its hit point maximum is reduced by an amount equal to the damage taken. This reduction lasts until the target finishes a long rest. The target dies if this effect reduces its hit point maximum to 0."}, "longsword": {"type": "melee", "attack_bonus": 4, "reach": "5 ft.", "damage": "1d8 + 2", "damage_type": "slashing"}, "longbow": {"type": "ranged", "attack_bonus": 4, "range": "150/600 ft.", "damage": "1d8 + 2", "damage_type": "piercing"}}', 'The word "wight" meant "person" in days of yore, but the name now refers to evil undead who were once combatants.', 'rules.txt', 186);

-- CR 6+ Monsters
INSERT INTO monsters (name, slug, size, type, subtype, alignment, armor_class, armor_type, hit_points, hit_dice, speed, ability_scores, saving_throws, skills, senses, languages, challenge_rating, challenge_rating_numeric, experience_points, traits, actions, legendary_actions, description, source_document, source_page) VALUES
('Young Black Dragon', 'young-black-dragon', 'Large', 'dragon', NULL, 'chaotic evil', 18, 'natural armor', 127, '15d10 + 45', '{"walk": 40, "fly": 80, "swim": 40}', '{"strength": 19, "dexterity": 14, "constitution": 17, "intelligence": 12, "wisdom": 11, "charisma": 15}', '{"dexterity": 5, "constitution": 6, "wisdom": 3, "charisma": 5}', '{"perception": 6, "stealth": 5}', '{"blindsight": 30, "darkvision": 120, "passive_perception": 16}', ARRAY['Common', 'Draconic'], '7', 7, 2900, '{"amphibious": "The dragon can breathe air and water."}', '{"multiattack": "The dragon makes three attacks: one with its bite and two with its claws.", "bite": {"type": "melee", "attack_bonus": 7, "reach": "10 ft.", "damage": "2d10 + 4", "damage_type": "piercing", "extra_damage": "1d8 acid"}, "claw": {"type": "melee", "attack_bonus": 7, "reach": "5 ft.", "damage": "2d6 + 4", "damage_type": "slashing"}, "acid_breath": {"recharge": "5-6", "save_dc": 14, "save_type": "Dexterity", "damage": "11d8", "damage_type": "acid", "area": "30-foot line that is 5 feet wide"}}', NULL, 'Black dragons are the most evil-tempered and vile of the chromatic dragons. They lurk in swamps, often establishing lairs in crumbling ruins.', 'rules.txt', 159),

('Adult Red Dragon', 'adult-red-dragon', 'Huge', 'dragon', NULL, 'chaotic evil', 19, 'natural armor', 256, '19d12 + 133', '{"walk": 40, "climb": 40, "fly": 80}', '{"strength": 27, "dexterity": 10, "constitution": 25, "intelligence": 16, "wisdom": 13, "charisma": 21}', '{"dexterity": 6, "constitution": 13, "wisdom": 7, "charisma": 11}', '{"perception": 13, "stealth": 6}', '{"blindsight": 60, "darkvision": 120, "passive_perception": 23}', ARRAY['Common', 'Draconic'], '17', 17, 18000, '{"legendary_resistance": "If the dragon fails a saving throw, it can choose to succeed instead. 3/day."}', '{"multiattack": "The dragon can use its Frightful Presence. It then makes three attacks: one with its bite and two with its claws.", "bite": {"type": "melee", "attack_bonus": 14, "reach": "10 ft.", "damage": "2d10 + 8", "damage_type": "piercing", "extra_damage": "2d6 fire"}, "claw": {"type": "melee", "attack_bonus": 14, "reach": "5 ft.", "damage": "2d6 + 8", "damage_type": "slashing"}, "tail": {"type": "melee", "attack_bonus": 14, "reach": "15 ft.", "damage": "2d8 + 8", "damage_type": "bludgeoning"}, "frightful_presence": {"save_dc": 19, "save_type": "Wisdom", "range": "120 feet", "effect": "frightened for 1 minute"}, "fire_breath": {"recharge": "5-6", "save_dc": 21, "save_type": "Dexterity", "damage": "18d6", "damage_type": "fire", "area": "60-foot cone"}}', '{"detect": "The dragon makes a Wisdom (Perception) check.", "tail_attack": "The dragon makes a tail attack.", "wing_attack": "The dragon beats its wings. Each creature within 10 feet must succeed on a DC 22 Dexterity saving throw or take 2d6 + 8 bludgeoning damage and be knocked prone. The dragon can then fly up to half its flying speed."}', 'Red dragons are the most covetous and greedy of all dragons, forever seeking to increase their treasure hoards.', 'rules.txt', 158);
