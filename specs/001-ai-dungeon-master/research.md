...
### Decision
Use a two-step AI flow where the configurable LLM (OpenAI or Gemini) generates structured output (narrative + state changes), then the server validates before persisting.
